...
* 事务隔离级别
  ...
  * PROPAGATION_NESTED：如果存在当前事务，则再当前事务的一个嵌套事务中执行，如果不存在当前事务，则创建新的事务，再新创建的事务中执行。
...
![RuleBasedTransactionAttribute](https://gitee.com/wangziming707/note-pic/raw/master/img/RuleBasedTransactionAttribute.png)
